...
public class W15_Skeleton extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(WizardLv15_1.QUEST.get_id()) || !pc.getQuest().isStart(WizardLv15_1.QUEST.get_id()) || pc.getInventory().checkItem(40605) || _random.nextInt(100) >= 40) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 40605, 1);
            return pc;
        } catch (Exception e) {

...
public class W30_BetrayerUndead extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(WizardLv30_1.QUEST.get_id()) || !pc.getQuest().isStart(WizardLv30_1.QUEST.get_id()) || pc.getInventory().checkItem(40579)) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 40579, 1);
            return pc;
        } catch (Exception e) {

...
public class W50_IncarnationVarlok extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(W50_IncarnationVarlok.class);
    private static Random _random = new Random();

    private W50_IncarnationVarlok() {
    }

    public static NpcExecutor get() {
        return new W50_IncarnationVarlok();
    }

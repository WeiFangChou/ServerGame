...
public class DE50_PriestCorruption extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(DarkElfLv50_1.QUEST.get_id()) || !pc.getQuest().isStart(DarkElfLv50_1.QUEST.get_id()) || pc.getInventory().checkItem(40600)) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 40600, 1);
            return pc;
        } catch (Exception e) {

...
public class W50_DiscipleDepravityT1 extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(W50_DiscipleDepravityT1.class);
    private static Random _random = new Random();

    private W50_DiscipleDepravityT1() {
    }

    public static NpcExecutor get() {
        return new W50_DiscipleDepravityT1();
    }

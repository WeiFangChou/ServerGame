...
public class C45_DevourerSouls extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(CrownLv45_1.QUEST.get_id()) || !pc.getQuest().isStart(CrownLv45_1.QUEST.get_id()) || pc.getInventory().checkItem(41422) || _random.nextInt(100) >= 40) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 41422, 1);
            return pc;
        } catch (Exception e) {

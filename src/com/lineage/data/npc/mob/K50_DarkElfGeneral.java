...
public class K50_DarkElfGeneral extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(KnightLv50_1.QUEST.get_id()) || !pc.getQuest().isStart(KnightLv50_1.QUEST.get_id()) || pc.getInventory().checkItem(49160)) {
                return pc;
            }
            switch (pc.getQuest().get_step(KnightLv50_1.QUEST.get_id())) {
                case 1:
                    ...
                    CreateNewItem.getQuestItem(pc, npc, 49160, 1);
                    return pc;
                default:
                    return pc;
            }

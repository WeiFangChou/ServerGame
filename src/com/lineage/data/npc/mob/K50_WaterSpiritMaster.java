...
public class K50_WaterSpiritMaster extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_WaterSpiritMaster.class);
    private static Random _random = new Random();

    private K50_WaterSpiritMaster() {
    }

    public static NpcExecutor get() {
        return new K50_WaterSpiritMaster();
    }

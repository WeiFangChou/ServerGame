...
public class K50_AbyssFireSpirit extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_AbyssFireSpirit.class);
    private static Random _random = new Random();

    private K50_AbyssFireSpirit() {
    }

    public static NpcExecutor get() {
        return new K50_AbyssFireSpirit();
    }

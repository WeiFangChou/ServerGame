...
public class I15_ContaminatedOrc extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(I15_ContaminatedOrc.class);
    private static Random _random = new Random();

    private I15_ContaminatedOrc() {
    }

    public static NpcExecutor get() {
        return new I15_ContaminatedOrc();
    }

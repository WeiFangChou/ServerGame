...
public class K50_AbyssWaterSpirit extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_AbyssWaterSpirit.class);
    private static Random _random = new Random();

    private K50_AbyssWaterSpirit() {
    }

    public static NpcExecutor get() {
        return new K50_AbyssWaterSpirit();
    }

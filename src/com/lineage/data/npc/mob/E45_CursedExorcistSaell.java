...
public class E45_CursedExorcistSaell extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(ElfLv45_2.QUEST.get_id()) || !pc.getQuest().isStart(ElfLv45_2.QUEST.get_id()) || pc.getInventory().checkItem(41349)) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 41349, 1);
            return pc;
        } catch (Exception e) {

...
public class W50_SuccubusVarlok extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(W50_SuccubusVarlok.class);
    private static Random _random = new Random();

    private W50_SuccubusVarlok() {
    }

    public static NpcExecutor get() {
        return new W50_SuccubusVarlok();
    }

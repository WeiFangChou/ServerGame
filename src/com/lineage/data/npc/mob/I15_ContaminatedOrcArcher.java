...
public class I15_ContaminatedOrcArcher extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(I15_ContaminatedOrcArcher.class);
    private static Random _random = new Random();

    private I15_ContaminatedOrcArcher() {
    }

    public static NpcExecutor get() {
        return new I15_ContaminatedOrcArcher();
    }

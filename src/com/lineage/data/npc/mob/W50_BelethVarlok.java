...
public class W50_BelethVarlok extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(W50_BelethVarlok.class);
    private static Random _random = new Random();

    private W50_BelethVarlok() {
    }

    public static NpcExecutor get() {
        return new W50_BelethVarlok();
    }

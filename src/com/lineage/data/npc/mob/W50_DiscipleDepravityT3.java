...
public class W50_DiscipleDepravityT3 extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(W50_DiscipleDepravityT3.class);
    private static Random _random = new Random();

    private W50_DiscipleDepravityT3() {
    }

    public static NpcExecutor get() {
        return new W50_DiscipleDepravityT3();
    }

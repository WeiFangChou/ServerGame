...
public class C15_BlackKnight extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(CrownLv15_1.QUEST.get_id()) || !pc.getQuest().isStart(CrownLv15_1.QUEST.get_id()) || pc.getInventory().checkItem(40565) || _random.nextInt(100) >= 40) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 40565, 1);
            return pc;
        } catch (Exception e) {

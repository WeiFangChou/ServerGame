...
public class DK15_OrcEmissaryA extends NpcExecutor {
    ...
    public L1PcInstance death(L1Character lastAttacker, L1NpcInstance npc) {
        try {
            ...
            if (pc == null || pc.getQuest().isEnd(DragonKnightLv15_1.QUEST.get_id()) || !pc.getQuest().isStart(DragonKnightLv15_1.QUEST.get_id()) || pc.getInventory().checkItem(49218) || _random.nextInt(100) >= 40) {
                return pc;
            }
            CreateNewItem.getQuestItem(pc, npc, 49218, 1);
            return pc;
        } catch (Exception e) {

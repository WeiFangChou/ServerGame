...
public class E50_GiantAnt extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(E50_GiantAnt.class);
    private static Random _random = new Random();

    private E50_GiantAnt() {
    }

    public static NpcExecutor get() {
        return new E50_GiantAnt();
    }

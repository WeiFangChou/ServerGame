...
public class K50_WindSpiritMaster extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_WindSpiritMaster.class);
    private static Random _random = new Random();

    private K50_WindSpiritMaster() {
    }

    public static NpcExecutor get() {
        return new K50_WindSpiritMaster();
    }

...
public class K50_AbyssWindSpirit extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_AbyssWindSpirit.class);
    private static Random _random = new Random();

    private K50_AbyssWindSpirit() {
    }

    public static NpcExecutor get() {
        return new K50_AbyssWindSpirit();
    }

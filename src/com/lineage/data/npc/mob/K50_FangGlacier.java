...
public class K50_FangGlacier extends NpcExecutor {
    private static final Log _log = LogFactory.getLog(K50_FangGlacier.class);
    private static Random _random = new Random();

    private K50_FangGlacier() {
    }

    public static NpcExecutor get() {
        return new K50_FangGlacier();
    }

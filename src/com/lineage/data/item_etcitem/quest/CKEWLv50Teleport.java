...
public class CKEWLv50Teleport extends ItemExecutor {
    public static ItemExecutor get() {
        return new CKEWLv50Teleport();
    }
            ...
            for (L1Object tgobj : mapList.values()) {
                if (tgobj instanceof L1PcInstance) {
                    ...
                    if (tgpc.get_showId() == pc.get_showId()) {
                        ...
                        if (tgpc.isCrown()) {
                            L1Teleport.teleport(tgpc, 32790, 32773, (short)2000, 2, true);
                            continue;
                        }
                        if (tgpc.isKnight()) {
                            L1Teleport.teleport(tgpc, 32788, 32773, (short)2000, 2, true);
                            continue;
                        }
                        if (tgpc.isElf()) {
                            L1Teleport.teleport(tgpc, 32788, 32771, (short)2000, 2, true);
                            continue;
                        }
                        if (tgpc.isWizard())
                            L1Teleport.teleport(tgpc, 32788, 32775, (short)2000, 2, true);
                    }
                }
            }
        } else {

...
public class PanaceaDex extends ItemExecutor {
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) throws Exception {
        if (pc.getBaseDex() >= ConfigAlt.POWERMEDICINE || pc.getElixirStats() >= ConfigAlt.MEDICINE) {
            if (pc.getBaseDex() >= ConfigAlt.POWERMEDICINE) {
                pc.sendPackets(new S_ServerMessage("Dex能力值" + ConfigAlt.POWERMEDICINE + "以後不能喝萬能藥! "));
            }

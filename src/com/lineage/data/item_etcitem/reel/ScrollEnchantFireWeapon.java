...
public class ScrollEnchantFireWeapon extends ItemExecutor {
    private ScrollEnchantFireWeapon() {
    }

    public static ItemExecutor get() {
        return new ScrollEnchantFireWeapon();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) throws Exception {
        ...
        if (tgItem != null) {
            ...
            switch (tgItem.getItem().getUseType()) {
                case 1:
                    if (oldAttrEnchantKind == 2 && oldAttrEnchantLevel >= ConfigOther.Enchant) {
                        isErr = true;
                        break;
                    }
                default:
            ...
            if (ConfigRate.ATTR_ENCHANT_CHANCE >= new Random().nextInt(100) + 1) {
                ...
                if (oldAttrEnchantKind != 2) {
                    newAttrEnchantLevel = 1;
                }
                tgItem.setAttrEnchantKind(2);

...
public class ScrollEnchantS3Weapon extends ItemExecutor {
    private ScrollEnchantS3Weapon() {
    }

    public static ItemExecutor get() {
        return new ScrollEnchantS3Weapon();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) throws Exception {
        ...
        if (tgItem != null) {
            ...
            switch (tgItem.getItem().getUseType()) {
                case 1:
                    if (oldAttrEnchantKind == 64 && oldAttrEnchantLevel >= 3) {
                        isErr = true;
                        break;
                    }
                default:
            ...
            if (ConfigRate.ATTR_ENCHANT_CHANCE >= new Random().nextInt(100) + 1) {
                ...
                if (oldAttrEnchantKind != 64) {
                    newAttrEnchantLevel = 1;
                }
                tgItem.setAttrEnchantKind(64);

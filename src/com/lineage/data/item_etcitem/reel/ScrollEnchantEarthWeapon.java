...
public class ScrollEnchantEarthWeapon extends ItemExecutor {
    private ScrollEnchantEarthWeapon() {
    }

    public static ItemExecutor get() {
        return new ScrollEnchantEarthWeapon();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) throws Exception {
        ...
        if (tgItem != null) {
            ...
            switch (tgItem.getItem().getUseType()) {
                case 1:
                    if (oldAttrEnchantKind == 1 && oldAttrEnchantLevel >= ConfigOther.Enchant) {
                        isErr = true;
                        break;
                    }
                default:
            ...
            if (ConfigRate.ATTR_ENCHANT_CHANCE >= new Random().nextInt(100) + 1) {
                ...
                if (oldAttrEnchantKind != 1) {
                    newAttrEnchantLevel = 1;
                }
                tgItem.setAttrEnchantKind(1);

...
public class EyeX_Figure extends ItemExecutor {
    private static final Log _log = LogFactory.getLog(EyeX_Figure.class);

    private EyeX_Figure() {
    }

    public static ItemExecutor get() {
        return new EyeX_Figure();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        if (item != null && pc != null) {
            try {
                ...
                pc.sendPacketsX8(new S_SkillSound(pc.getId(), 7676));
                ...
                SkillMode mode = L1SkillMode.get().getSkill(L1SkillId.DRAGON7);
                if (mode != null) {

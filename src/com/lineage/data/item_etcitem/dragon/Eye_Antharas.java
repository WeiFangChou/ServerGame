...
public class Eye_Antharas extends ItemExecutor {
    private static final Log _log = LogFactory.getLog(Eye_Antharas.class);

    private Eye_Antharas() {
    }

    public static ItemExecutor get() {
        return new Eye_Antharas();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        if (item != null && pc != null) {
            try {
                ...
                pc.sendPacketsX8(new S_SkillSound(pc.getId(), 7671));
                ...
                SkillMode mode = L1SkillMode.get().getSkill(L1SkillId.DRAGON2);
                if (mode != null) {

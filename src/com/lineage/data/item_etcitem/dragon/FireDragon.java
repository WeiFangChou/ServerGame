...
public class FireDragon extends ItemExecutor {
    private static final Log _log = LogFactory.getLog(FireDragon.class);
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) throws Exception {
        if (item != null && pc != null) {
            ...
            SkillMode mode = L1SkillMode.get().getSkill(L1SkillId.DRAGON1);
            if (mode != null) {
                try {

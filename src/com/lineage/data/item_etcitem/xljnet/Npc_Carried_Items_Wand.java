...
public class Npc_Carried_Items_Wand extends ItemExecutor {
    public static ItemExecutor get() {
        return new Npc_Carried_Items_Wand();
    }
            ...
            if (target instanceof L1MonsterInstance) {
                ...
                if (dropList != null) {
                    ...
                    for (int i2 = 0; i2 < dropList.size(); i2++) {
                        L1Item dropitem = ItemTable.get().getTemplate(dropList.get(i2).getItemid());
                        ...
                        itemdatas[i2] = String.valueOf(blessed) + dropitem.getName();

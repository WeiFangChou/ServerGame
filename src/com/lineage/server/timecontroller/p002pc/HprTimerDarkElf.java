...
/* renamed from: com.lineage.server.timecontroller.pc.HprTimerDarkElf */
public class HprTimerDarkElf extends TimerTask {
    private static final Log _log = LogFactory.getLog(HprTimerDarkElf.class);
    ...
    public void run() {
        try {
            ...
            _log.error("Pc(黑妖) HP自然回復時間軸異常重啟", e);

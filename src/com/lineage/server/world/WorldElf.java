...
public class WorldElf {
    ...
    private final ConcurrentHashMap<Integer, L1PcInstance> _isElf = new ConcurrentHashMap<>();
    ...
    public Collection<L1PcInstance> all() {
        try {
            ...
            Collection<L1PcInstance> vs2 = Collections.unmodifiableCollection(this._isElf.values());
            this._allPlayer = vs2;
            return vs2;
        } catch (Exception e) {

...
public class MobGroupTable {
    ...
    public void load() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= 7; i++) {
                    minions.add(new L1NpcCount(rs.getInt("minion" + i + "_id"), rs.getInt("minion" + i + "_count")));
                }
                _mobGroupIndex.put(Integer.valueOf(mobGroupId), new L1MobGroup(mobGroupId, leaderId, minions, isRemoveGroup));
            }
    ...
    public L1MobGroup getTemplate(int mobGroupId) {
        return _mobGroupIndex.get(Integer.valueOf(mobGroupId));
    }
}
